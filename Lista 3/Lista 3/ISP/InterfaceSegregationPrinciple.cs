...
namespace Lista_3.ISP
{
    /* Co prawda to jest klasa a nie interfejs, i jestem pewny że tu gdzieś był lepszy przykład. */
    class MembershipBreaking : MembershipProvider
    {
        /// <summary>
